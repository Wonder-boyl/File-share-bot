...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7934086431:AAExbaMy0BfTlzE0WQI805HsVpY9sjakZD0")

# API ID Anda dari my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "8465056"))

# API Hash Anda dari my.telegram.org
API_HASH = os.environ.get("API_HASH", "6ddf5d5aa190b0f818e3731a39bd407d")

# ID Channel Database
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002202717422"))

# NAMA OWNER
OWNER = os.environ.get("OWNER", "@Tamil_Gintama")
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "5519278195").split())]
except ValueError:
